// Credit: https://github.com/mantinedev/mantine/blob/master/src/mantine-styles/src/theme/utils/rem/rem.test.ts

import { em, rem } from './rem';

describe('Vinena/styles/rem', () => {
